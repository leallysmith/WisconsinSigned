...
jsonSource_SignedParcelslastupdated102523_14.addFeatures(features_SignedParcelslastupdated102523_14);cluster_SignedParcelslastupdated102523_14 = new ol.source.Cluster({
  distance: 10,
...
lyr_GoogleTerrain_0.setVisible(true);lyr_GoogleImagery_1.setVisible(true);lyr_ESRIGray_2.setVisible(true);lyr_OpenStreetMap_3.setVisible(true);lyr_CoalClosureEnergyCommunities_4.setVisible(true);lyr_MSANonMSAsthatareEnergyCommunities_5.setVisible(true);lyr_AdditionalSelectionCriteriaGeographicOption2PersistentPovertyCounty_6.setVisible(true);lyr_AdditionalSelectionCriteriaGeographicOption1CEJSTEnergy_7.setVisible(true);lyr_Category1Eligibility_8.setVisible(true);lyr_WisconsinUtilities_9.setVisible(true);lyr_Wisconsin_10.setVisible(true);lyr_WisconsinCounties_11.setVisible(true);lyr_CountyNames_12.setVisible(false);lyr_SignedParcelslastupdated102523_13.setVisible(true);lyr_SignedParcelslastupdated102523_14.setVisible(true);lyr_ParcelNames_15.setVisible(false);
var layersList = [group_Basemaps,group_EnergyCommunities,group_48eLowIncomeCredits,lyr_WisconsinUtilities_9,lyr_Wisconsin_10,lyr_WisconsinCounties_11,lyr_CountyNames_12,lyr_SignedParcelslastupdated102523_13,lyr_SignedParcelslastupdated102523_14,lyr_ParcelNames_15];
