...
var format_CoalClosures_4 = new ol.format.GeoJSON();
var features_CoalClosures_4 = format_CoalClosures_4.readFeatures(json_CoalClosures_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CoalClosures_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CoalClosures_4.addFeatures(features_CoalClosures_4);
var lyr_CoalClosures_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CoalClosures_4, 
                style: style_CoalClosures_4,
                interactive: true,
    title: 'Coal Closures<br />\
    <img src="styles/legend/CoalClosures_4_0.png" /> Census tract directly adjoining a census tract with a coal closure<br />\
    <img src="styles/legend/CoalClosures_4_1.png" /> Census tract with a coal closure<br />'
        });
var format_2023EnergyCommunities_5 = new ol.format.GeoJSON();
var features_2023EnergyCommunities_5 = format_2023EnergyCommunities_5.readFeatures(json_2023EnergyCommunities_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_2023EnergyCommunities_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_2023EnergyCommunities_5.addFeatures(features_2023EnergyCommunities_5);
var lyr_2023EnergyCommunities_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_2023EnergyCommunities_5, 
                style: style_2023EnergyCommunities_5,
                interactive: true,
    title: '2023 Energy Communities<br />\
    <img src="styles/legend/2023EnergyCommunities_5_0.png" /> is an energy community, as it meets both the Fossil Fuel Employment (FFE) threshold and the unemployment rate requirement<br />'
        });
...
jsonSource_SignedParcelslastupdated102523_13.addFeatures(features_SignedParcelslastupdated102523_13);
...
lyr_CoalClosures_4.set('fieldLabels', {});
lyr_2023EnergyCommunities_5.set('fieldLabels', {});
